...
const insertSampleChat = function() {
  Chat.create(samplechat).then(() => console.log("Chat test"));
};
const insertSampleName = function() {
  Name.create(sampleName).then(() => console.log("name"));
};
const insertSampleUser = function() {
  User.create(sampleUser).then(() => console.log("user test"));
};
const insertSampleCompany = function() {
  Company.create(sampleCompany).then(() => console.log("company test "));
};
insertSampleName();
insertSampleChat();
insertSampleUser();
